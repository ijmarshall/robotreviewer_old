...
class BiasRobot:
    ...
    def __init__(self):
        ...
        self.sent_clf = MiniClassifier(os.path.join(abs_dir, 'robots/bias/bias_sent_level.npz'))
        self.doc_clf = MiniClassifier(os.path.join(abs_dir, 'robots/bias/bias_doc_level.npz'))
